...
namespace Opsive.OmniAnimation.Packs.Shared
{
    ...
    public class IndividualAnimationDisplay : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            m_MotionController = m_Character.GetComponent<MotionController>();
            m_MotionController.UseRootMotionPosition = m_MotionController.UseRootMotionPosition = m_UseRootMotion;
        ...
        /// <summary>
        /// Updates if the controller should use root motion.
        /// </summary>
        /// <param name="useRootMotion">Should root motion be used?</param>
        public void UpdateRootMotion(bool useRootMotion)
        {
            m_UseRootMotion = useRootMotion;
            m_MotionController.UseRootMotionPosition = m_MotionController.UseRootMotionPosition = m_UseRootMotion;
        }
